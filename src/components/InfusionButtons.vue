...
<template>
  <div>
    ...
    >
      ...
      <div class="4xl:w-[5.25VW] md:w-[8VW] w-[25vw] truncate pl-2 text-ellipsis">
        {{ props.ward }}
      </div>
      <div class="4xl:w-[5.25VW] md:w-[8VW] w-[25vw] truncate pl-2 text-ellipsis">
        {{ props.bed }}
      ...
      <div
        class="4xl:w-[3.5VW] xl:w-[3VW] md:w-[10VW] w-[20vw] rounded-2xl bg-red-500 truncate pl-2 right-3 text-ellipsis text-white"
      >
        {{ props.drug }}
      </div>
    </button>
