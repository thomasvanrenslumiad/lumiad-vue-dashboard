...
const notifier = computed(() => {
  if (props.remainingMl === 0) {
    return 'm-2 flex 4xl:w-[27VW] xl:w-[25.5VW] md:w-[52vw] w-[88vw] cursor-pointer rounded-full bg-red-200 hover:bg-red-500 hover:text-white focus:bg-red-700 focus:text-white focus:outline-2 data-[state=on]:bg-red-700 focus:outline-offset-2 focus:outline-red-800 active:bg-gray-700 active:text-white outline-red-500 outline-5  '
  } else if (props.mlPerHour === 0) {
    return 'm-2 flex 4xl:w-[27VW] xl:w-[25.5VW] md:w-[52vw] w-[88vw] cursor-pointer rounded-full bg-yellow-200 hover:bg-yellow-500 hover:text-white focus:bg-yellow-700 data-[state=on]:bg-yellow-700 focus:text-white focus:outline-2 focus:outline-offset-2 focus:outline-red-500 active:bg-gray-700 active:text-white outline-orange-500 outline-3  '
  } else {
    return 'm-2 flex 4xl:w-[27VW] xl:w-[25.5VW] md:w-[52vw]  w-[88vw] cursor-pointer rounded-full bg-gray-400 hover:bg-gray-500 hover:text-white focus:bg-gray-700 data-[state=on]:bg-gray-700 focus:text-white focus:outline-2 focus:outline-offset-2 focus:outline-black active:bg-gray-700 active:text-white '
  }
})
</script>
...
<template>
  <div>
    <button @click="routeIt(props.id)" :class="notifier">
      ...
      <div class="4xl:w-[6.85VW] md:w-[12VW] w-[25vw] truncate text-ellipsis">
        {{ props.timeRemaining }}
      </div>
      <div class="4xl:w-[6.85VW] md:w-[12VW] w-[25vw] truncate pl-2 text-ellipsis">
        {{ props.ward }}
      </div>
      <div class="4xl:w-[6.85VW] md:w-[12VW] w-[25vw] truncate pl-2 text-ellipsis">
        {{ props.bed }}
      ...
      <div
        class="4xl:w-[3.5VW] xl:w-[3VW] md:w-[15VW] w-[20vw] rounded-2xl bg-red-500 truncate pl-2 text-ellipsis text-white"
      >
        {{ props.drug }}
      </div>
    </button>
